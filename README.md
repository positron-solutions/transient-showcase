...
Revisit the section on [detangling setting, saving and history](#org2bb3908).  Watching the values update will make it clear what representations are bing stored, where, and when.
