...
*** Reading custom infix values
    ...
    The most simple way to read args...
    ...
    =transient-arg-value= is somewhat intended for infixes used in CLI's.

    #+name: custom-infixes
    #+begin_src elisp :tangle yes :var _=custom-infixes
      ...
      (transient-define-prefix ts-inception-update ()
        "Pick a suffix, any suffix, and modify it!"
