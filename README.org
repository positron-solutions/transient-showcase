...
** TODO Add set, save, history support    
   
   This example is really cool because it works with an arbitary object, but it
   needs support for serializing & de-serializing via =transient-values=.
