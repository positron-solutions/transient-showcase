...
*** Reading custom infix values
    ...
    This works okay if values were exported, which usually is true during suffix
    bodies.  (See [[id:0c106a1b-d824-4321-89a5-b1e06b468c63][the precommand
    sections of flow control]])
